...
public interface DataStore {
    ...
    /**
     * Returns the ClientCredentials used to authenticate HTTPS requests sent to the Stormpath API server.
     *
     * @return the ClientCredentials used to authenticate HTTPS requests sent to the Stormpath API server.
     * @since 1.0.RC3
     */
